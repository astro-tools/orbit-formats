...
# when it loses some — and that every such warning is structured.
...
def assert_no_silent_loss() -> NoSilentLossCheck:
    ...
    name at least one dropped field. The conversion graph and the format writers reuse
    this fixture on their real converters as they land.
    """

    def check(conversion: Callable[[], object], *, loses: bool) -> None:
